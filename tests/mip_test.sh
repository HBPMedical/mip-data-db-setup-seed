...
$DOCKER_COMPOSE build with_research_data_db_check
...
echo
echo "Test adding research data"
$DOCKER_COMPOSE run edsd_data_db_setup
$DOCKER_COMPOSE run adni_merge_db_setup
$DOCKER_COMPOSE run ppmi_data_db_setup
$DOCKER_COMPOSE run with_research_data_db_check
