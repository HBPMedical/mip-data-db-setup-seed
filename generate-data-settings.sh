...
cat << EOF > src/main/java/eu/humanbrainproject/mip/migrations/${view}_view.properties
# suppress inspection "UnusedProperty" for whole file
...
echo "Generated src/main/java/eu/humanbrainproject/mip/migrations/${view}_view.properties"
